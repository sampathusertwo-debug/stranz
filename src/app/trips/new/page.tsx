...
export default function NewTripPage() {
  ...
  const fetchTrip = async (id: string) => {
    try {
      ...
      setFormData({
        ...
        start_odometer_reading: String(data.start_odometer_reading || ''),
        end_odometer_reading: String(data.end_odometer_reading || ''),
        notes: data.notes || '',
      });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.party_id || !formData.truck_id || !formData.vehicle_type_id || !formData.from_location || !formData.to_location || !formData.freight_amount) {
    ...
    try {
      const payload = {
        ...
        start_odometer_reading: formData.start_odometer_reading ? parseFloat(formData.start_odometer_reading) : null,
        end_odometer_reading: formData.end_odometer_reading ? parseFloat(formData.end_odometer_reading) : null,
      };
                    ...
                    <Grid container spacing={3}>
                      ...
                      <Grid item xs={12} sm={6}>
                        ...
                        <TextField
                          ...
                          type="number"
                          value={formData.start_odometer_reading}
                          onChange={(e) => handleChange('start_odometer_reading', e.target.value)}
                          fullWidth
                        />
                      </Grid>
